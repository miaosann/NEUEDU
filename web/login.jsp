                    ...
                    <form role="form" method="get" action="/LoginServlet">
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="姓名" type="name" id="name" autofocus>
                            </div>
                            <div class="form-group">
                                <input class="form-control" placeholder="身份证号" id="password" type="text" value="">
                            </div>
                            <!-- Change this to a button or input when using this as a form -->
                            <button class="btn btn-lg btn-success btn-block" type="button" onclick="checkName();">查询</button>
                            <span id="result"></span>
                        </fieldset>
                    </form>
                </div>
