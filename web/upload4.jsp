            ...
            <div class="col-lg-6 col-lg-offset-3" >
                <div class="login-panel panel panel-default">
                    <div class="panel-body">
                        <form role="form" action="photoUpdate" method="post" enctype="multipart/form-data">
                            <input id="lefile" type="file" name="file2" accept="application/zip" style="display:none" onchange="$('input[id=photoCover]')[0].value=this.value;">
                            <div class="input-append" style="margin-bottom:50px;">
                                <label for="lefile">外语核对照片上传</label><br>
                                <div class="col-lg-8">
